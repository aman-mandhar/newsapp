    ...
    <div class="news-block">
        ...
        <div class="row g-3 mb-4 news-grid">
            @php
                ...
                ->select(['id','title','slug','image_path', 'views_count', 'published_at'])
                            ...
                            <div class="news-cover">
                                @php
                                    ...
                                    if ($post->status === 'draft' && $authUser && $authUser->id === $post->user_id) {
                                        echo '<a href="'.route('posts.edit', $post->id).'" class="position-absolute top-0 end-0 m-2 btn btn-sm btn-warning" title="Edit Draft Post"><i class="bi bi-pencil-square"></i></a>';
                                    }
                                @endphp
